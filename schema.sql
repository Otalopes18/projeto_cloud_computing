-- Schema para recrutamento
CREATE DATABASE IF NOT EXISTS recrutamento_db CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE recrutamento_db;
...
-- para garantir que um candidato nao se inscreva duas vezes na mesma vaga, voce pode criar um index unico:
